...
"
" silent! unlet g:loaded_vim_goto_file_after_plugin_includeexpr_for_gf

if exists("g:loaded_vim_goto_file_after_plugin_includeexpr_for_gf") || &cp
  finish
endif

let g:loaded_vim_goto_file_after_plugin_includeexpr_for_gf = 1
